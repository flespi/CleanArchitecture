...
public class TodoLists : EndpointGroupBase
{
    ...
    public async Task<Results<NoContent, BadRequest>> UpdateTodoList(ISender sender, int id, UpdateTodoListCommand command, [FromHeader(Name = "If-Match")] string concurrencyToken)
    {
