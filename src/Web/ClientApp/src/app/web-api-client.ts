...
export interface ITodoItemsClient {
    ...
    createTodoItem(idempotencyKey: string | null | undefined, command: CreateTodoItemCommand): Observable<number>;
...
export interface ITodoListsClient {
    ...
    createTodoList(idempotencyKey: string | null | undefined, command: CreateTodoListCommand): Observable<number>;
