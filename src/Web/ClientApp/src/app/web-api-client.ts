...
export class TodosVm implements ITodosVm {
    priorityLevels?: LookupDtoOfInteger[];
    lists?: TodoListDto[];
        ...
        if (_data) {
            if (Array.isArray(_data["priorityLevels"])) {
                ...
                for (let item of _data["priorityLevels"])
                    this.priorityLevels!.push(LookupDtoOfInteger.fromJS(item));
            }
...
export class LookupDtoOfInteger implements ILookupDtoOfInteger {
    id?: number;
    title?: string | undefined;

    constructor(data?: ILookupDtoOfInteger) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): LookupDtoOfInteger {
        data = typeof data === 'object' ? data : {};
        let result = new LookupDtoOfInteger();
        result.init(data);
        return result;
    }
...
export interface ILookupDtoOfInteger {
    id?: number;
    title?: string | undefined;
}
